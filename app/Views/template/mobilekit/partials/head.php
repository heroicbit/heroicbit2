...
<style>
  ...
  .sk-chase-dot:before { background-color: #3A9288 }
  ...
  .toast-message a, .toast-message label { color: #ffeb3b;font-weight: bold;text-decoration: underline; }

  .appBottomMenu, .toast-top, .toast-bottom { max-width: 576px !important; margin: 0 auto; }
