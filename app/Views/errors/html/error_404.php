...
<head>
	...
	<!-- Favicons -->
	<link href="<?= base_url(); ?>/theme/assets/img/favicon.png" rel="icon">
	...
	<link href="<?= base_url(); ?>/theme/assets/vendor/quill/quill.snow.css" rel="stylesheet">
	<link href="<?= base_url(); ?>/theme/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
	<link href="<?= base_url(); ?>/theme/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
	<link href="<?= base_url(); ?>/theme/assets/vendor/simple-datatables/style.css" rel="stylesheet">
	...
	<main>
		<div class="container">
			...
			<section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
				...
				<img src="<?= base_url(); ?>/theme/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
				<div class="credits">
