        ...
        <div class="swiper swiper-article" x-init="initSwiperArticles">
            <div class="swiper-wrapper py-2">
                <template x-for="article in data.posts">
                    <div class="swiper-slide">
                        <a :href="article.youtube_url ? `/member/videos/${ article.id }` : `/member/feeds/${ article.id }`">
                            ...
                            <div class="thumbnail-image thumbnail-image-rounded position-relative">
                                    ...
                                    <img :src="article?.medias ? article.medias[0].url : article.featured_image" :alt="article.title" class="card-img-top swiper-thumbnail-image rounded-4"/>
                                </div>
